...
* You must place the E5600SG controller into maintenance mode if you are not using the Grid Manager. Placing the controller into maintenance mode interrupts the connection to the E2700 controller. Before changing the link configuration, you must xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[place the E5600SG controller into maintenance mode]. 
+
