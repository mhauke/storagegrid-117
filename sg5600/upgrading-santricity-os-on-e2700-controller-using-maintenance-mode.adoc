...
* You have placed the E5600SG controller into link:../commonhardware/placing-appliance-into-maintenance-mode.html[maintenance mode]. Placing the controller into maintenance mode interrupts the connection to the E2700 controller. 
+
