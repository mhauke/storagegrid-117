...
+
If you made changes to the VLAN settings, the subnet for the appliance might have changed. If you need to change the IP addresses for the appliance, follow the xref:../installconfig/setting-ip-configuration-sg5600.adoc[set IP configuration] instructions.
