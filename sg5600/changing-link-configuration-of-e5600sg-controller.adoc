...
link:../commonhardware/placing-appliance-into-maintenance-mode.html[Place the E5600SG controller into maintenance mode]. 
...
. Use the Ping Test tool to check connectivity to IP addresses on any networks that might have been affected by the link configuration changes you made in the <<change_link_configuration_sg5600,Change link configuration>> step.
+
