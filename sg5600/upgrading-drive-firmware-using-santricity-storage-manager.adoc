...
The firmware could not be downloaded, possibly because of a physical problem with the drive.
  ...
  **** *Not attempted*
+
The firmware was not downloaded. For example, the download was stopped before it could occur, the drive did not qualify for the upgrade, or the download could not occur due to an error.
