...
* The appliance has been xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[placed in maintenance mode] if the component replacement procedure requires that you shut down the appliance.
