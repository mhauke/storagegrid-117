...
* The appliance has been link:../commonhardware/placing-appliance-into-maintenance-mode.html[placed in maintenance mode] if the component replacement procedure requires that you shut down the appliance.
...
a|
Follow the steps in link:replacing-e2700-controller.html[Replace E2700 controller], but install the new battery in the existing controller.
a|
|===
