...
summary: Beginning with StorageGRID 11.7, Grid Manager is integrated with BlueXP. Accessing your StorageGRID system from BlueXP allows you to use the familiar Grid Manager interface, while providing a complete view of the data across your hybrid multicloud. 
---
...
[.lead]
Beginning with StorageGRID 11.7, Grid Manager is integrated with BlueXP. Accessing your StorageGRID system from BlueXP allows you to use the familiar Grid Manager interface, while providing a complete view of the data across your hybrid multicloud.
...
When you're ready to manage your StorageGRID system from BlueXP, you can follow the link that appears when you access the Grid Manager, or you can go directly to BlueXP. Going directly to BlueXP provides an advantage, if you'd like to use BlueXP's data services to back up data, scan and categorize your data, and more.

=== Use the link from Grid Manager

When you connect the Grid Manager interface from your web browser, you are prompted to manage your StorageGRID system with the Grid Manager in BlueXP or to use the Grid Manager directly. To use the Grid Manager in BlueXP, perform the following steps.

.What you'll need
You have the URL for the Grid Manager, which can be a fully qualified domain name, the IP address of an Admin Node, or the virtual IP address of an HA group of Admin Nodes

.Steps

. Open a web browser and enter the Grid Manager URL.
+
