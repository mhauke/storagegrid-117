...
| NODES
| Some Graphana-based charts and metrics are not available.
...
| CONFIGURATION
| * *Traffic classification* > *Metrics* tab
* *Security settings* > *Browser inactivity timeout* tab
* *Single sign-on* page
 ...
 * *Grid topology* page
* *Metrics* page
* All pages related to *Alarms (legacy)*
* *Link cost* page
* *NMS entities* page
