...
xref:../installconfig/installing-appliance-in-cabinet-or-rack-sg100-and-sg1000.adoc[Install appliance into a cabinet or rack (SG100 and SG1000)]
...
xref:../installconfig/viewing-boot-up-codes-for-appliance-sg100-and-sg1000.adoc[View boot-up codes for appliance]
