...
* You have recorded any configuration changes you have made in the the BMC interface link:../installconfig/accessing-bmc-interface.html[Access the BMC interface]
...
. Restore any configuration changes that were made for the replaced appliance. See link:../installconfig/configuring-bmc-interface.html[Configure BMC interface]
