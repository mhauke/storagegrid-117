---
permalink: sg5700n/changing-link-configuration-of-e5700sg-controller.html
sidebar: sidebar
...
xref:placing-appliance-into-maintenance-mode.adoc[Place E5700SG controller into maintenance mode]. 
...
+
If you made changes to the VLAN settings, the subnet for the appliance might have changed. If you need to change the IP addresses for the appliance, follow the xref:../installconfig/setting-ip-configuration-sg5700.adoc[set IP configuration] instructions.
...
xref:../installconfig/configuring-network-links-sg5700.adoc[Configure network links (SG5700)]
