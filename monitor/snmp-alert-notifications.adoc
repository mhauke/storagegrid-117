...
Alert notifications are sent by whichever Admin Node is configured to be the preferred sender. By default, the primary Admin Node is selected. See the link:../admin/index.html[instructions for administering StorageGRID].
