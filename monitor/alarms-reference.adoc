...
a|
If audit relays are not connected to ADC services, audit events can't be reported. They are queued and unavailable to users until the connection is restored.
