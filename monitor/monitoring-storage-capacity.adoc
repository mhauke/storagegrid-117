...
+
For more information on planning a storage expansion, see the link:../expand/index.html[instructions for expanding StorageGRID].
...
|Allowed
|The space allowed for object metadata on this Storage Node. To learn how this value is determine for each Storage Node, see the link:../admin/managing-object-metadata-storage.html#allowed-metadata-space[full description of Allowed metadata space].
...
image::../media/forecast-metadata-usage.png[Forcast of metadata usage by site]