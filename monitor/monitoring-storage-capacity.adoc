...
If you notice that the rate of consumption changes over time, select a shorter range to reflect only the most recent ingest patterns. If you notice seasonal patterns, select longer range.
