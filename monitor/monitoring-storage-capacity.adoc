...
Monitor space usage forecasts for user data and metadata to estimate how quickly space will be consumed. These values can help you determine when you need to add storage for user data and metadata.
...
. Use these values to estimate when you need to add new Storage Nodes for data and metadata storage. 
