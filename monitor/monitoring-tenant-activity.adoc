...
. Review the information on the Tenant pages.
+
...
+
See link:../admin/grid-federation-overview.html[Use grid federation] and link:../admin/grid-federation-manage-tenants.html[Manage the permitted tenants for grid federation].
