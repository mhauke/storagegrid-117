...
+
See xref:../admin/grid-federation-overview.adoc[What is grid federation] and xref:../admin/grid-federation/manage-tenants.adoc[Manage the permitted tenants for grid federation].
