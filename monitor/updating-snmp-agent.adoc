...
.About this task
Whenever you update the link:configuring-snmp-agent.html[SNMP agent configuration], be aware that you must click *Save* at the bottom on the SNMP Agent page to commit any changes you have made on each tab.
