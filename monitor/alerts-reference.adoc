...
. Review the settings on the Grid Federation page for both the local and the remote grids. Confirm that all values are correct. See xref:../admin/grid-federation-manage-connection.adoc[Manage grid federation connections].
