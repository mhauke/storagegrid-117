...
xref:monitoring-system-health.adoc#view-current-and-resolved-alerts[View current alerts]
...
xref:monitoring-system-health.adoc#view-current-and-resolved-alerts[View current and resolved alerts]
...
xref:../installconfig/set-up-email-alert-notifications.adoc[Set up email notifications for alerts]
