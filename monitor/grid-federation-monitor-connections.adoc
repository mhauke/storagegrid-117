...
[.lead]
You can monitor basic information about all grid federation connections or detailed information about a specific connection. You can monitor a connection from either grid. 
