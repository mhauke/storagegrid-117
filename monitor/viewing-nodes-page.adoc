...
To view the available information, select or search for the grid, site, or node:
...
* Enter either the system name or the display name for the grid, site, or node in the *Search* field.