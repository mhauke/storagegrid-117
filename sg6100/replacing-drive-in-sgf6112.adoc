...
* You have verified which drive has failed by noting that the drive's left LED is blinking amber.
...
//The picture shows the drives and labels: 
...
+
The drive is automatically rebuilt with mirrored data from the working drives. You can check the status of the rebuild by using the Grid Manager.
