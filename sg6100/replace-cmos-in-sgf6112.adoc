...
---
= Remove and replace the CMOS battery in the SGF6112
:icons: font
:imagesdir: ../media/
...
Draft placeholder--do not review.
...
* You have the correct replacement CMOS.
...
* You have the correct replacement CMOS battery.
