...
IMPORTANT: To prevent degraded performance, do not twist, fold, pinch, or step on the cables.
 ...
 .. Note the position of the removable components (two power supplies, eight cooling fans, three NICs, and twelve SSDs) in the failed appliance.
+
...
HDD07
|=== 
 .. Transfer the removable components to the replacement appliance. 
+
Follow the maintenance instructions provided for replacing the removable components.
+
IMPORTANT: If you wish to retain the data on the drives, be sure to insert the SSD drives into the same locations they occupied in the failed appliance. Otherwise, you might receive a warning message. 
