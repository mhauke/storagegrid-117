...
+
WARNING: To prevent data loss if the Appliance Installer indicates that physical hardware changes are required, such as swapping disk drives to the replacement appliance, power down the appliance before making hardware changes.
+
