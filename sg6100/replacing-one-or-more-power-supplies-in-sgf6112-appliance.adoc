...
* You have the correct replacement power supply of the same wattage as the power supply you are replacing.
* You have determined the location of the power supply to replace.
+
link:verify-component-to-replace.html[Verify component to replace]

* You have physically located the SGF6112 appliance where you are replacing the power supply in the data center.
+
...
+
When viewed from the rear of the appliance, power supply PSU1 is on the left and PSU0 is on the right. 
