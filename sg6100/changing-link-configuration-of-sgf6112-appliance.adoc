...
summary: 'You can change the Ethernet link configuration of the appliance. You can change the port bond mode, the network bond mode, and the link speed.'
---
= Change link configuration of appliance
:icons: font
:imagesdir: ../media/

[.lead]
You can change the Ethernet link configuration of the appliance. You can change the port bond mode, the network bond mode, and the link speed.
...
Options for changing the Ethernet link configuration of the appliance include:
...
+
For more information on the options, see xref:../installconfig/configuring-network-links.adoc[Configure network links].
...
+
If you made changes to the VLAN settings, the subnet for the appliance might have changed. If you need to change the IP addresses for the appliance, see xref:../installconfig/setting-ip-configuration.adoc[Configure StorageGRID IP addresses].
