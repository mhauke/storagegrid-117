...
+
link:verify-component-to-replace.html[Verify location of component to replace]
...
+
image::../media/sgf6112_two-slot-riser_guide-pin.png[Guide pin on SGF6112 for two-slot riser assembly]
...
.. Locate the guide pin on the system board 
+
image::../media/sgf6112_one-slot-riser_system-pin.png[Guide pin on SGF6112 for one-slot riser assembly]
