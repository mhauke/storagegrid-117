...
summary: 'You might need to replace one of the Network Interface Cards in the SGF6112 if it is not functioning optimally or if it has failed.'
---
...
[.lead]
You might need to replace one of the Network Interface Cards in the SGF6112 if it is not functioning optimally or if it has failed.
...
+
link:verifying-component-to-replace.html[Verify component to replace]
