...
For information on configuring audit message levels and using an external syslog server, see link:../monitor/configure-audit-messages.html[Configure audit messages and log destinations].
