...
In their default format, the audit messages in the audit log files are not easy to read or interpret. You can use the link:using-audit-explain-tool.html[audit-explain tool] to obtain simplified summaries of the audit messages in the audit log. You can use the link:using-audit-sum-tool.html[audit-sum tool] to summarize how many write, read, and delete operations were logged and how long these operations took.
