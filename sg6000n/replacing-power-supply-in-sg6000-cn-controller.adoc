...
NOTE: Both power supplies must have the same wattage. If you need to replace both power supplies, see xref:replacing-both-power-supplies-in-sg6000-cn-controller.adoc[Replacing both power supplies in the SG6000-CN controller].
