...
+
NOTE: Hardware-specific installation and integration instructions are not included in the StorageGRID installation procedure. To learn how to install StorageGRID appliances, see the link:../installconfig/index.html[Quick start for hardware installation] to locate instructions for your appliance.
