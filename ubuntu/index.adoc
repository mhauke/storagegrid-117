...
+
NOTE: Hardware-specific installation and integration instructions aren't included in the StorageGRID installation procedure. To learn how to install StorageGRID appliances, see the link:../installconfig/index.html[Quick start for hardware installation] to locate instructions for your appliance.
