...
There are many ways to achieve consistent network interface naming across multiple hosts; see xref:configuring-host-network.adoc[Configure the host network] for some examples.
