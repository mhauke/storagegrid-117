...
. Select one or more xref:admin-group-permissions.adoc[admin group permissions].
+
...
.. Optionally, select or unselect xref:admin-group-permissions.adoc[admin group permissions].
.. Select *Save changes*.
