...
AutoSupport for appliances reports StorageGRID hardware issues, while StorageGRID AutoSupport reports StorageGRID software issues. You must configure AutoSupport for appliance hardware on each appliance. It is implemented differently for services and storage appliances.
