...
+
NOTE: If the SSO Status options do not appear, confirm you have configured the identity provider as the federated identity source. See link:requirements-for-sso.html[Requirements for using single sign-on].
