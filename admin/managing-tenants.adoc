...
* Optionally, a storage quota for the tenant account, which is the maximum amount of storage available for the tenant's objects. If the quota is exceeded, the tenant cannot create new objects.
+
