...
* If you will use HTTP, you have configured a proxy server to convert AutoSupport messages to HTTPS. As of the StorageGRID 11.7 release, NetApp's AutoSupport servers will reject messages sent using HTTP.
...
* *HTTP*: If you select HTTP, you must configure a proxy server to convert AutoSupport messages to HTTPS. NetApp's AutoSupport servers reject messages sent using HTTP. This protocol uses port 80. 
