...
NOTE: If you want to keep object deletions in sync between grids, create an link:../s3/create-s3-lifecycle-configuration.html[S3 lifecycle configuration] for the buckets on both grids. 
