...
NOTE: You cannot enable node encryption after an appliance is added to the grid, and you cannot use external key management for appliances that don't have node encryption enabled.
