...
* Link costs are used by the Load Balancer service on Admin Nodes and Gateway Nodes to direct client connections. See xref:../admin/how-load-balancing-works.adoc[How load balancing works].
