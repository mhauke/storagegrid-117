...
Review the considerations for link:grid-federation-manage-tenants.html[managing permitted tenants]. Then, create one or more new tenant accounts, assign the *Use grid federation connection* permission, and select the new connection. 
