...
Creating a grid federation connection includes steps on both grids. You start the configuration on one grid and complete it on the other grid. You can start the configuration from either grid.

image:../media/grid-federation-create-connection.png[illustration is described by text]
...
. When you are ready, create one or more new tenant accounts to use this connection. See xref:creating-tenant-account.adoc[Create a tenant account].
