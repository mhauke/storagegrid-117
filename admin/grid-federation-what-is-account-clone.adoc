...
If neither grid uses SSO, you can configure identity federation at the grid level or you can grant each tenant permission to configure its own identity source. 
