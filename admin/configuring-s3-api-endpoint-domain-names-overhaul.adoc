---
permalink: admin/configuring-s3-api-endpoint-domain-names-overhaul.html
sidebar: sidebar
...
. Enter the list of S3 endpoint domain names in the textboxes.

. Select *Add another domain name* to add additional fields.
+
