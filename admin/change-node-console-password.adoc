...
+
You can use the old passwords in the current Recovery Package if the password change process fails for any node. You can find the name of the node where the node console password failed to change in the details section of the Change node console passwords page in step 3.
