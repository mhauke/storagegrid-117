...
* If the tenant is permitted to use a grid federation connection, you have reviewed the considerations for xref:admin/grid-federation-manage-tenants.adoc[deleting a tenant with the Use grid federation connection permission].
