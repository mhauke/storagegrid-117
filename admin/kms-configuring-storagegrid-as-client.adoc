...
These instructions apply to Thales CipherTrust Manager. Use the https://https://mysupport.netapp.com/matrix[NetApp Interoperability Matrix Tool^] to get a list of supported versions. If you have questions about using a different key management server with StorageGRID, contact technical support at https://thalesdocs.com/ctp/cm/latest/[Thales CipherTrust Manager^].
