...
* To disable the *Use grid federation connection* permission, follow the instructions for xref:grid-federation-manage-tenants.adoc[removing a tenant's permission to use grid federation].
+
