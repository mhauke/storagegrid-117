...
image::../media/kms_overhaul_configuration_details_table.png[KMS configuration details KMS table]
...
+
See the recommended actions for these alerts in the instructions for xref:../monitor/index.adoc[monitoring and troubleshooting StorageGRID].
