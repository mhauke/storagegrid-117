...
== Rename or delete an S3 endpoint domain name
...
To delete an S3 endpoint domain name, select the delete icon next to the domain name and select *Yes* in the confirmation dialog box to confirm your deletion.
