...
. To learn more about the failure, review the link:../monitor/grid-federation-monitor-connections.html[cross-grid replication metrics].
...
. To confirm that the issue was resolved, review the link:../monitor/grid-federation-monitor-connections.html[cross-grid replication metrics] or perform these steps:
