...
. Select the *Connection name* for the alert to go to the Grid federation page.
+
You can also go to *CONFIGURATION* > *System* > *Grid federation* to locate the connection.
