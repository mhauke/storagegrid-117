...
+ 
The TLS and SSH policies tab shows the available policies. The currently active policy is noted by a green checkmark in the policy tile.
+
...
+
A green checkmark appears next to *Current policy* in the policy tile.
