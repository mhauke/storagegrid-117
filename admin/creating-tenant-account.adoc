...
+
If you selected the *Use grid federation connection* permission for the tenant, a new tenant with the same name and the same 20-digit account ID is automatically created on the other grid in the grid federation connection.
