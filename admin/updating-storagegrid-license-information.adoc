...
[IMPORTANT]
If you need to change the terms of your license or you want to merge, split, or redistribute an existing license, contact support to open a non-technical support case.  
