...
If you plan to use S3 virtual hosted-style requests, you have xref:../admin/configuring-s3-api-endpoint-domain-names.adoc[configured S3 endpoint domain names]. Using virtual hosted-style requests is recommended.
