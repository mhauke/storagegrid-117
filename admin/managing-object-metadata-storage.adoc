...
The _Metadata Reserved Space_ is a system-wide setting that represents the amount of space that will be reserved for metadata on volume 0 of every Storage Node. As shown in the table, the default value of this setting for StorageGRID 11.6 or higher is based the following:
...
|===
| Version used for initial StorageGRID installation| Amount of RAM on Storage Nodes| Default Metadata Reserved Space setting for StorageGRID 11.6 or higher
...
//11.7: add new storagegrid_storage_utilization_metadata_actual_reserved_bytes metric. Existing text for 11.6: The *Actual reserved* value corresponds to this Prometheus metric:
...
* To learn how to monitor the object metadata capacity for each Storage Node, go to link:../monitor/index.html[Monitor and troubleshoot].

* To increase the object metadata capacity for your system, add new Storage Nodes. Go to link:../expand/index.html[Expand your grid].
