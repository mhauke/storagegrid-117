...
* To monitor the object metadata capacity for each Storage Node, see link:../monitor/monitoring-storage-capacity.html[Monitor storage capacity].
...
* To determine if you can increase the Metadata Reserved Space setting for your system, see link:increasing-metadata-reserved-space-setting.html[Increase Metadata Reserved Space setting].
