...
You can edit a connection using either grid in the connection. When you edit a grid federation connection, you must download a new verification file on one grid and then upload the new verification file on the other grid.
