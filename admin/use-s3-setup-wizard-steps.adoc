...
sidebar: sidebar
keywords: FabricPool and S3 setup wizard, ontap system manager
...
[.lead]
You can use the S3 setup wizard to configure StorageGRID as the object storage system for a FabricPool cloud tier.
