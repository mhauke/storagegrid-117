...
* If you can't select an interface, its check box is disabled. The tool tip provides more information. 
+
...
.. Optionally, select or clear the check boxes to add or remove interfaces.
+
