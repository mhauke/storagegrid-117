...
The tab displays a field where you can enter addresses you want to allow to access closed port. Any previously configured addresses are also displayed. 

+
image::../media/privileged-address-list.png[Privileged address list]

. In the Address 1 field, enter the IP address of a client or IP subnet in CIDR notation you want to allow access to closed ports. 
