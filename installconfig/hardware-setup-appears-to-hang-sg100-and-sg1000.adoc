...
link:viewing-boot-up-codes-for-appliance-sg100-and-sg1000.html[View boot-up codes for appliance]

link:viewing-error-codes-for-sg1000-controller-sg100-and-sg1000.html[View error codes for appliance]
