---
permalink: installconfig/rebooting-controller-while-storagegrid-appliance-installer-is-running.html
sidebar: sidebar
keywords: storage node, storage appliance, reboot, restart 
...
+
The storage appliance controller is rebooted.
