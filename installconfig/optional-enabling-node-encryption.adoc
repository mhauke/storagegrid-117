...
If you are using https://configbuilder.netapp.com/index.aspx[ConfigBuilder^] or the link:automating-installation-configuration-appliance-nodes-configure-sga-py-script.html[configure-sga.py script] to generate a JSON file, you can enable node encryption automatically.
