...
If you are using https://configbuilder.netapp.com/index.aspx[ConfigBuilder^] to generate a JSON file, you can enable node encryption automatically.  See link:automating-appliance-installation-and-configuration.html[Automate appliance installation and configuration].
