...
** To add an appliance Storage Node to an existing StorageGRID system, see the instructions for link:../expand/adding-grid-nodes-to-existing-site-or-adding-new-site.html[adding grid nodes].
** To deploy an appliance Storage Node as part of a recovery operation, see instructions link:../maintain/recovering-storagegrid-appliance-storage-node.html[recovering an appliance Storage Node].
