...
summary: 'You must install rails in your cabinet or rack and then slide the appliance onto the rails. If you have an SG5760, install the drives after installing the appliance.'
---
= Install SG5700 appliance in cabinet or rack
:icons: font
:imagesdir: ../media/

[.lead]
You must install rails in your cabinet or rack and then slide the appliance onto the rails. If you have an SG5760, install the drives after installing the appliance.
