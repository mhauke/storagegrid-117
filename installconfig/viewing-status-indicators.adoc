...
This light is not used by SG6100 series appliances and remains off. 
...
*Note:* If a new working SSD is inserted into a working SG6100 series StorageGRID node, the LEDs on the SSD should blink initially, but stop blinking as soon as the system determines that the drive has enough capacity and is functional.
