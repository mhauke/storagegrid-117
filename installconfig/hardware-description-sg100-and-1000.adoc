...
+
IMPORTANT: If you use Admin Nodes and Gateway Nodes in the same HA group, Admin Node-only port will not fail over. See the instructions for xref:../admin/configure-high-availability-group.html#create-a-high-availability-group.adoc[configuring HA groups].
