...
The following figures shows the three controllers in the SG6060 and SG6060X appliances, with the SG6000-CN compute controller on the top and the two E2800 storage controllers on the bottom. The SG6060 uses E2800A controllers, and the SG6060X uses E2800B controllers. 
...
*SG6060: Connect SG6000-CN to two E2800A controllers*

image::../media/sg6000_e2800_connections.png[SG6060 to E2800A Connections]

*SG6060X: Connect SG6000-CN to two E2800B controllers*
...
*SGF6024: Connect SG6000-CN to two EF570 controllers*
