...
Use the table to gather information for administration and maintenance connections.
...
Use the table to gather information for networking connections.
...
Use the table to gather information for Grid Network connections.
...
Use the table to gather information for Client Network connections.
...
Use the table to gather information for BMC management network connections.
