...
*SG6000-CN fixed port bond mode* 
...
*SG6000-CN aggregate port bond mode* 
...
*SG6000-CN Admin Network ports bonded* 
...
*E5700SG aggregate port bond mode* 
...
*E5700SG Admin Network ports bonded*
