...
Make sure that you have the following items before configuring the network links for your appliance.
...
Each appliance has unique port-bonding requirements.
...
Complete the following steps to configure the network links for your appliance.
