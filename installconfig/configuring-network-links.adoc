...
For the SG6000, if you plan to use the 25-GbE link speed for the 10/25-GbE ports:
...
For the SG5700, if you plan to use Active-Backup mode for the Admin Network, you have connected Ethernet cables to both management ports on the controller.
