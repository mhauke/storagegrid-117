...
image::../media/e5700sg_bonded_management_ports.gif[SG6000 Bonded Mananagement Ports]
...
image::../media/e5600sg_aggregate_ports_bonded.gif[Management Ports Bonded]
