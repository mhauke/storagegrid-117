...
* Work with your NetApp professional services consultant to use link:https://configbuilder.netapp.com/index.aspx[NetApp ConfigBuilder tool^] to complete these steps:

[cols="2a,2a" options=header] 
|===
| Consult professional services| Use ConfigBuilder
| Step 1: Get sales order number
| Step 2: Get workbook

| Step 3: Complete workbook
| Step 4: Upload workbook

| Step 5: Import JSON file
| Step 6: Generate JSON file

2+| Appliance ready for installation
| 
|===
