...
* Using the NetApp ConfigBuilder tool, create a JSON file that specifies the configuration settings for your appliances. Upload the JSON file using the StorageGRID Appliance Installer. For guidance using link:https://configbuilder.netapp.com/index.aspx[ConfigBuilder^], contact your NetApp account representative.
+
...
. Generate the JSON file using the link:https://configbuilder.netapp.com/[NetApp ConfigBuilder tool^]. Contact your NetApp account representative for guidance.
