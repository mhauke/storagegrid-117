...
+
NOTE: If you are deploying the Admin Node appliance as a node cloning target, stop the deployment process here and continue the xref:../commonhardware/appliance-node-cloning-procedure.adoc[node cloning procedure].
