...
NOTE: You can also configure the system using the xref:../primer/exploring-grid-manager.adoc[Grid Manager] or the xref:overview-of-installation-rest-apis.adoc[Installation API].
