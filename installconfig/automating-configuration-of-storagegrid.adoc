...
NOTE: You can also configure the system using the link:../primer/exploring-grid-manager.html[Grid Manager] or the link:overview-of-installation-rest-apis.html[Installation API].
