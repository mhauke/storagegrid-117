...
NOTE: You can also configure the system using the xref:../admin/index.adoc[Grid Manager] or the xref:overview-of-installation-rest-apis.adoc[Installation API].
