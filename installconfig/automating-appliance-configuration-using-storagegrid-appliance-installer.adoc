...
NOTE: Experienced users who want to automate both the installation and configuration of their appliances can xref:automating-installation-configuration-appliance-nodes-configure-sga-py-script.adoc[use the configure-sga.py script].
 ...
 ** The xref:automating-installation-configuration-appliance-nodes-configure-sga-py-script.adoc[`configure-sga.py` appliance configuration script]. You can download the script from the StorageGRID Appliance Installer (*Help* > *Appliance Configuration Script*).
+
