...
. Confirm that the site meets the requirements for temperature, humidity, altitude range, airflow, heat dissipation, wiring, power, and grounding. See the xref:https://hwu.netapp.com[NetApp Hardware Universe^] for more information.
...
. Install any required network switches. See the xref:https://mysupport.netapp.com/matrix[NetApp Interoperability Matrix Tool^] for compatibility information.
