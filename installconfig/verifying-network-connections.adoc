...
. Optionally, select the *Test MTU* checkbox to verify the MTU setting for the entire path through the network to the destination.
+
...
* link:../commonhardware/changing-mtu-setting.html[Change MTU setting]
