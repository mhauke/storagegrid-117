...
. link:https://configbuilder.netapp.com/index.aspx[Acess NetApp ConfigBuilder tool^]
+
ConfigBuilder enables you to complete a configuration spreadsheet and create a Build Guide and Build Script.
