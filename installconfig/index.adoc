...
** link:connecting-power-cords-and-applying-power-sgf6100.html[SG6100]
...
. Access and configure SANtricity management tools if needed (E-Series based Storage Nodes only)
...
. link:configuring-bmc-interface.html[Configure the BMC interface (SG6100, SG6000, SG100, and SG1000)] 
