...
xref:../installconfig/controllers-in-sg6000-appliances.adoc[Controllers in SG6000 appliances]

xref:../installconfig/reviewing-appliance-network-connections.adoc[Review appliance network connections (SG6000)]
...
xref:/installconfig/configuring-storagegrid-ip-addresses.adoc[Configure StorageGRID IP addresses]
