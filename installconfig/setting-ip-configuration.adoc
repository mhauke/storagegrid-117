...
If you want to change the link configuration, see the instructions for changing the link configuration of the services appliance or storage appliance controller:

* xref:../sg6000/changing-link-configuration-of-sg6000-cn-controller.adoc[Change link configuration of the SG6000-CN controller]
* xref:../sg5700/changing-link-configuration-of-e5700sg-controller.adoc[Change link configuration of the E5700SG controller]
* xref:../sg5600/changing-link-configuration-of-e5600sg-controller.adoc[Change link configuration of the E5600SG controller]
* xref:../sg100-1000/changing-link-configuration-of-services-appliance.adoc[Change link configuration of the SG100 or SG1000 services appliance]
