...
* xref:changing-link-configuration-of-services-appliance.adoc[Change link configuration of the SG100 or SG1000 services appliance]
* xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Change link configuration of the SG6000-CN controller]
