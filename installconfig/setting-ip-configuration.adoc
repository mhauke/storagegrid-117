...
If you are using https://configbuilder.netapp.com/index.aspx[ConfigBuilder^] or the link:automating-installation-configuration-appliance-nodes-configure-sga-py-script.html[configure-sga.py script] to generate a JSON file, you can configure IP addresses automatically.
...
* link:../sg5600/changing-link-configuration-of-e5600sg-controller.html[Change link configuration of the E5600SG controller]
