---
permalink: installconfig/optional-remapping-network-ports-for-appliance-sg5600-and-sg5700.html
sidebar: sidebar
...
---
= Optional: Remap network ports for appliance (SG5600 and SG5700)
:icons: font
:imagesdir: ../media/
