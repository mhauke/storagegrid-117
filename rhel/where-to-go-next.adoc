...
+
NOTE: When you install StorageGRID, the default ILM policy, Baseline 2 copies policy, is active. This policy includes the system-provided ILM rule (Make 2 Copies), and it applies if no other policy has been activated.
...
* Review and follow the StorageGRID StorageGRID xref:../harden/index.adoc[system hardening guidelines] to eliminate security risks.
