...
* Accept inbound client traffic only on explicitly configured endpoints. See the information about xref:../admin/manage-firewall-controls.adoc[managing firewall controls].
