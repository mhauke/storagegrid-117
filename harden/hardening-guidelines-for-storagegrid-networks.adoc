...
For detailed information about StorageGRID networks, see the xref:../network/storagegrid-network-types.adoc[StorageGRID network types].
...
* Block all internal traffic ports on the Admin Network. See the xref:../network/internal-grid-node-communications.adoc[list of internal ports].
...
* Block all internal traffic ports on the Client Network. See the xref:../network/internal-grid-node-communications.adoc[list of internal ports].
* Accept inbound client traffic only on explicitly configured endpoints. See the information about xref:../admin/managing-untrusted-client-networks.adoc[managing untrusted Client Networks].
