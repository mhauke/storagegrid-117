...
NOTE: As of the StorageGRID 11.7 release, NetApp's servers will reject AutoSupport messages sent using HTTP. You must xref:../admin/configuring-admin-proxy-settings.adoc[create a proxy server] to convert AutoSupport messages to HTTPS.
