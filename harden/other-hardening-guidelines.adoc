...
Help protect your object data from ransomware attacks by following the guidelines in https://www.netapp.com/media/69498-tr-4921.pdf[Ransomware defense with StorageGRID^].