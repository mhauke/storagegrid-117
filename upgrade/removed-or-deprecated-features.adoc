...
You should remove Archive Nodes from active ILM policies in StorageGRID 11.7 or earlier. Removing object data stored in Archive Nodes will simplify future upgrades.
