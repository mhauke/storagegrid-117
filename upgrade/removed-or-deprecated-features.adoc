...
The legacy CLB service has been removed in StorageGRID 11.7. The CLB ports 8082, 8083, 8084, and 8085 will be converted to load balancer endpoints during the upgrade to StorageGRID 11.7.
