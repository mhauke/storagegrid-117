...
Archive Nodes should be removed from active ILM policies in StorageGRID 11.7 or earlier. Removing any object data stored in Archive Nodes will simplify future upgrades.

See link:../ilm/index.html[Manage objects with ILM].