...
The Network and objects tab allows you to set an encryption type for stored objects and select network security options. See link:../admin/changing-network-options-object-encryption.html[Change network options].
