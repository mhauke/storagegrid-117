...
* The maintenance instructions common to all appliance models were combined, consolidated, and moved to the maintenance section of this documentation site.
+
link:../commonhardware/index.html[Common node maintenance: Overview]

* The maintenance instructions specific to each appliance model were moved to the maintenance section of this documentation site.
+
