...
=== Can select storage grade when adding Storage Nodes
When you add a new Storage Node in an expansion, you can now specify which storage grade will be assigned to the node. See xref:../expand/performing-expansion.adoc[Perform expansion].
