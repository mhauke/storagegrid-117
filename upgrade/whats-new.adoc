...
You can now use S3 Select with Admin and Gateway load balancer endpoints that are bare metal nodes running Debian 11 or running a kernel with cgroup v2 enabled.
