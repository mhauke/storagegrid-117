...
=== Grid federation
You can now create a connection between two StorageGRID systems. Grid connections let you synchronize account information and replicate objects between grids for disaster recovery. See link:../admin/grid-federation-overview.html[Use grid federation: Overview].
