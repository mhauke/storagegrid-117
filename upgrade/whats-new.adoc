...
See xref:../tenant/using-s3-object-lock.html.adoc[Use S3 Object Lock to retain objects] and xref:../s3/using-s3-object-lock.adoc[Use S3 REST API to configure S3 Object Lock].
