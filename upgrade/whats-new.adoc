...
=== New sample group policy for ransomware mitigation
The sample policy prevents older object versions from being permanently deleted. See xref:../tenant/creating-groups-for-s3-tenant.adoc[Create groups for an S3 tenant].
