...
=== Grid federation, account clone, and cross-grid replication
You can now create a connection between two StorageGRID systems. Grid connections let you synchronize account information and replicate objects between grids for disaster recovery. See xref:../admin/grid-federation-overview.adoc[What is grid federation], xref:../admin/grid-federation-what-is-account-clone.adoc[What is account clone], and xref:../admin/grid-federation-what-is-cross-grid-replication.adoc[What is cross-grid replication].
