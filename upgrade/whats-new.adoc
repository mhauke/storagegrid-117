...
=== BlueXP integration
Grid Manager is now integrated with BlueXP. Adding your StorageGRID system to BlueXP allows you to use the familiar Grid Manager interface, while providing a complete view of the data across your hybrid multicloud. See link:../bluexp-integration.html[BlueXP integration] and https://docs.netapp.com/us-en/cloud-manager-family/concept-overview.html[BlueXP overview^].
