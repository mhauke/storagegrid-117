...
The legacy CLB service has been removed in StorageGRID 11.7. The CLB ports 8082, 8083, 8084, and 8085 will be converted to load balancer endpoints during the upgrade, and the *Legacy CLB load balancer activity detected* alert will be triggered. See the alert text for more information.