...
See xref:../s3/use-s3-object-lock.adoc#get-object-lock-configuration[GET Object Lock Configuration] for detailed information.
...
* You can include the `x-amz-bucket-object-lock-enabled` request header to create a bucket with S3 Object Lock enabled. See xref:../s3/use-s3-api-for-s3-object-lock.adoc[Use S3 REST API to configure S3 Object Lock].
+
...
See xref:../s3/use-s3-object-lock.adoc#put-object-lock-configuration[PUT Object Lock Configuration] for detailed information.
|===
...
xref:bucket-and-group-access-policies.adoc[Use bucket and group access policies]
