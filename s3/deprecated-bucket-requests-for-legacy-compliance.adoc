...
* link:../s3/deprecated-get-bucket-compliance-request.html[Deprecated - GET Bucket compliance request]
...
* link:../s3/deprecated-put-bucket-compliance-request.html[Deprecated - PUT Bucket compliance request]
