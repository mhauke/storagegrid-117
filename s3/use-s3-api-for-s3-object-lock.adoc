...
* Manage bucket settings from the Tenant Manager. See xref:../tenant/creating-s3-bucket.adoc[Create an S3 bucket] and xref:../tenant/update-default-retention-settings.adoc[Update  S3 Object Lock default retention]. 
