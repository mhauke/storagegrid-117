...
.What you'll need
* You have the UUID of any lost object, as identified in link:investigating-lost-objects.html[Investigate lost objects].
...
When you are logged in as root, the prompt changes from `$` to `#`.
 ...
 .. Use grep to extract the link:../audit/object-ingest-transactions.html.html[audit messages associated with the potentially lost object] and send them to an output file. Enter: `grep uuid-valueaudit_file_name > output_file_name`
+
For example:
+
----
