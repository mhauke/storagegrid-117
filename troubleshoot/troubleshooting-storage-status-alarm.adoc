...
. As required, xref:../expand/guidelines-for-adding-object-capacity.adoc[add storage capacity].
+
Also see xref:../admin/managing-full-storage-nodes.adoc[Manage full Storage Nodes].
