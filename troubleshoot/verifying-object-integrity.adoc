...
+
This procedure is similar to the one for link:investigating-lost-objects.html[investigating lost objects], although for object copies you search for `LLST` instead of `OLST`.
