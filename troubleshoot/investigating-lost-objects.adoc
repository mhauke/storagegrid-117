...
. From an Admin Node, xref:../audit/accessing-audit-log-file.adoc[access the audit log] to determine the unique identifier (UUID) of the object that triggered the *Objects lost* alert:
