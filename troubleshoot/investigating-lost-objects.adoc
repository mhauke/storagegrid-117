...
. From an Admin Node, access the xref:../audit/index.adoc[audit log] to determine the unique identifier (UUID) of the object that triggered the *Objects lost* alert:
