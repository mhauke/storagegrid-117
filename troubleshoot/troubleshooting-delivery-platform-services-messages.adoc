...
For additional information, see the xref:../admin/troubleshooting-platform-services.adoc[Troubleshoot platform services]. You might need to xref:../tenant/signing-in-to-tenant-manager.adoc[access the tenant from the Tenant Manager] to debug a platform service error.
