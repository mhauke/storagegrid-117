...
summary: 'You can monitor the status of repair jobs you initiated using the `repair-data` script from the command line.'
---
...
[.lead]
You can monitor the status of repair jobs you initiated using the `repair-data` script from the command line.
