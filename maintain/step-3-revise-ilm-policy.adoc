...
* Cannot use the All Storage Nodes storage pool (StorageGRID 11.6 or earlier) or the All Sites site.
...
+
NOTE: Do not use the *All Storage Nodes* storage pool (StorageGRID 11.6 or earlier) in the erasure coding profiles.
