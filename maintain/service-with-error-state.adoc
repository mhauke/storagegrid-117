...
----
+
NOTE: If the service status is `disabled`, see the instructions for link:removing-donotstart-file-for-service.html[removing a DoNotStart file for a service].
