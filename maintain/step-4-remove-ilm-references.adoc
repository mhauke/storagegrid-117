 ...
 ** The system-provided *Make 2 Copies* rule uses the system-default *All Storage Nodes* storage pool, which uses the All Sites site.
...
+
IMPORTANT: You must delete the system-provided *Make 2 Copies* rule before you can decommission a site.
