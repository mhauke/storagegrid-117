...
+
NOTE: If you xref:../installconfig/configuring-bmc-interfacee.adoc[configured the BMC interface] when you set up hardware, you should record and validate the configuration and reapply it if necessary. For example, you should confirm the settings for SNMP trap destinations and email notifications.
