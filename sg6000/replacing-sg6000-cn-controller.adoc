...
+
NOTE: If you applied xref:../installconfig/configuring-hardware.adoc[additional customization during the original installation], such as setting SNMP trap destinations or email notifications, you should record and validate the configuration and reapply it if necessary.
