...
.. link:shutting-down-sg6000-cn-controller.html[Shut down the appliance].
...
. link:../installconfig/connecting-power-cords-and-applying-power-sg6000.html[Connect the power cords to the replaced units and apply power].
