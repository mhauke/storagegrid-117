...
. Follow the instructions for xref:../installconfig/sg6060-installing-60-drive-shelves-into-cabinet-or-rack.adoc[installing 60-drive shelves into a cabinet or rack].

. Follow the instructions for xref:../installconfig/sg6060-installing-drives.adoc[installing the drives].
...
+
The green checkmark icon means that no alerts are active and the node is connected to the grid. For a description of node icons, see xref:../monitor/monitoring-node-connection-states.html.adoc[Monitor node connection states].
