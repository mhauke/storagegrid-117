...
a|
Ethernet switch port you will connect to management port 1 (labeled as P1 on the E2800A controller and 0a on the E2800B controller)
a|

a|

a|
MAC address for management port 1 (printed on a label near port P1 on the E2800A controller and 0a on the E2800B controller)
a|
...
xref:../6000/controllers-in-sg6000-appliances.adoc[Controllers in SG6000 appliances]

xref:../installconfig/port-bond-modes-for-sg6000-cn-controller.adoc[Port bond modes for SG6000-CN controller]

xref:..installconfig/cabling-appliance-sg6000.adoc[Cable appliance (SG6000)]

xref:../installconfig/configuring-storagegrid-ip-addresses-sg6000.adoc[Configure StorageGRID IP addresses]
