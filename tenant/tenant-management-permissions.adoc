...
| Allows users to create and remove their own S3 access keys. Users who do not have this permission do not see the *STORAGE (S3)* > *My S3 access keys* menu option.
...
| When combined with the Manage all buckets permission, allows users to access the Experimental S3 Console and use it to manage objects.
