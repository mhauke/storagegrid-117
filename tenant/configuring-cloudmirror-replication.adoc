...
For general information on bucket replication and how to configure it, see https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication.html[Amazon Simple Storage Service (S3) documentation: Replicating objects]. For information on how StorageGRID implements GetBucketReplication, DeleteBucketReplication, and PutBucketReplication, see the link:../s3/operations-on-buckets.html[Operations on buckets].
