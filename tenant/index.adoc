...
TIP: While you can create and manage S3 buckets with the Tenant Manager, you must have link:../s3/index.html[S3 access keys and use the S3 REST API to ingest and manage objects].
