...
* You belong to a user group that has the Root access permission or that has both the Manage all buckets and Manage objects with S3 Console xref:tenant-management-permissions.adoc[permissions].
