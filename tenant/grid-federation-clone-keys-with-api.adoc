...
. Using the Tenant Manager, link:creating-your-own-s3-access-keys.html[create your own access keys] and download the `.csv` file.
...
. Using the Tenant Manager, link:creating-another-users-s3-access-keys.html[create the other user's S3 access keys] and download the `.csv` file.
