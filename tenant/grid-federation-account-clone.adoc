...
The workflow diagram shows the steps that the users of a cloned tenant account will perform to clone groups, users, and S3 access keys. These steps are described in more detail below.
