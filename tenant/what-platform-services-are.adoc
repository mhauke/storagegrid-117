...
summary: 'StorageGRID platform services can help you implement a hybrid cloud strategy by allowing you to send notifications and copies of S3 objects and object metadata to external destinations.'
---
...
[.lead]
StorageGRID platform services can help you implement a hybrid cloud strategy by allowing you to send notifications and copies of S3 objects and object metadata to external destinations.
...
* *CloudMirror replication*: The link:understanding-cloudmirror-replication-service.html[StorageGRID CloudMirror replication service] is used to mirror specific objects from a StorageGRID bucket to a specified external destination.
+
...
* *Notifications*: link:understanding-notifications-for-buckets.html[Per-bucket event notifications] are used to send notifications about specific actions performed on objects to a specified external Amazon Simple Notification Service™ (SNS).
+
...
* *Search integration service*: The link:understanding-search-integration-service.html[search integration service] is used to send S3 object metadata to a specified Elasticsearch index where the metadata can be searched or analyzed using the external service.
+
