...
NOTE: If your tenant account has the *Use grid federation connection* permission, users that are added to a group on the source grid are not cloned when the group is cloned to the destination grid. 
