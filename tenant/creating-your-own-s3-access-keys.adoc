...
+
<<<<<<< HEAD
NOTE: In the expiration date textbox, the expiration date should not exceed five years from the current date. The expiration time should be a minimum of one minute from the current time.

=======
NOTE: In the expiration date textbox, the expiration date should not exceed five years from the current date.
>>>>>>> f8574f80f67c1fbc651a4a0b857d946643fabd6d
+
