...
To see a workflow diagram of the steps for configuring cross-grid replication, see link:../admin/grid-federation-workflow.html#workflow-for-cross-grid-replication[Workflow for cross-grid replication].
