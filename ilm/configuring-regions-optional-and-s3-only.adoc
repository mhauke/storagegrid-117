...
+
You can now select these regions from the *Location Constraint* list on the Advanced Filtering page of the Create ILM rule wizard. See xref:create-ilm-rule-enter-details.adoc#use-advanced-filters-in-ILM-rules[Use advanced filters in ILM rules].
