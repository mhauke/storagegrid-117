...
+
You can now select these regions from the Advanced Filtering section in step 1 of the Create ILM rule wizard. See xref:create-ilm-rule-enter-details.adoc#use-advanced-filters-in-ilm-rules.adoc[Use advanced filters in ILM rules].
