...
. Select *ILM* > *Policies*.
+
The ILM policies page appears. From this page, you can review the list of active, historical, and proposed policies; create, edit, or remove a proposed policy; clone the active policy; or view the details for any policy.
