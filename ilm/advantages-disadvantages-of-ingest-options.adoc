...
summary: 'Understanding the advantages and disadvantages of each of the three options for protecting data at ingest \(Dual commit, Strict, or Balanced\) can help you decide which one to select for an ILM rule.'
---
...
[.lead]
Understanding the advantages and disadvantages of each of the three options for protecting data at ingest (Dual commit, Strict, or Balanced) can help you decide which one to select for an ILM rule.

== Advantages of the Strict and Balanced options
...
== Disadvantages of the Strict and Balanced options

When compared to Dual commit, the Strict and Balanced options have some disadvantages:

* *Longer client ingests*: Client ingest latencies might be longer. When you use the Strict and Balanced options, an "`ingest successful`" message is not returned to the client until all erasure-coded fragments or replicated copies are created and stored. However, object data will most likely reach its final placement much faster.
...
== Limitations on object placements with the Strict and Balanced options

The Strict or Balanced options cannot be used for ILM rules that have any of these placement instructions:
