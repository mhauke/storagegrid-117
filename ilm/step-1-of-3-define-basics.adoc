...
+
If you do not configure advanced filtering, the rule applies to all objects that match the basic filters. For more information about advanced filtering, see xref:using-advanced-filters-in-ilm-rules.adoc[Use advanced filters in ILM rules].
+
...
. Select *Next*.
+
Step 2 (Define Placements) appears. See xref:step-2-of-3-define-placements.adoc[Step 2 of 3: Define placements].
