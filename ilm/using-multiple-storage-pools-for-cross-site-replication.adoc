...
* Storage pool 1 contains Sites 1 through 6
* The ILM rule contains one placement: Store objects by erasure coding using a 6+3 EC scheme at Storage pool 1

=== ILM rule placement for Store objects by erasure coding using a 6+3 EC scheme at Storage pool 1

image::../media/ilm_erasure_coding_6+3.png[Store objects by erasure coding using a 6+3 EC scheme at Storage pool 1]
