...
summary: 'If your data protection needs change or you add new sites, you can create and activate a new ILM policy.'
---
...
[.lead]
If your data protection needs change or you add new sites, you can create and activate a new ILM policy.
...
In this example, a new StorageGRID site has been added in an expansion, and a new active ILM policy needs to be implemented to store data at the new site. To implement a new active policy, you either xref:working-with-ilm-rules-and-ilm-policies.adoc#clone-a-historical-ilm-policy[clone a historical policy and change it] or xref:creating-proposed-ilm-policy.adoc[create a proposed policy]. In either case, you must xref:simulating-ilm-policy.adoc[simulate] and then xref:activating-ilm-policy.adoc[activate] the new policy.
