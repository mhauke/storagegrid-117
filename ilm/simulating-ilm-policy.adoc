...
* The Simulate active policy page retains the objects you tested until you close, navigate away from, or refresh the ILM policies page.
...
. In the *Object* field, enter the S3 bucket/object-key or the Swift container/object-name for a test object.
