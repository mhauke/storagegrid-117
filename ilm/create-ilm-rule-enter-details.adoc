...
+
If you select *Yes*, "`Noncurrent time`" will be automatically selected for Reference time in xref:create-ilm-rule-define-placements.adoc[Step 2 of the Create an ILM rule wizard].
+
