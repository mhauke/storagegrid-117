...
// commenting out bcs all of this is listed in creating-cloud-storage-pool. Keeping it here just in case.
...
//* The provider type: Amazon S3/GCP or Azure Blob storage.
//+
//Select Amazon S3 if you are using Google Cloud Platform.
