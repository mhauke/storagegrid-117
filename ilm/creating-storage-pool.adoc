...
+
The Storage Pools page appears. This page lists all defined storage pools; the system-default storage pool, All Storage Nodes, which uses the system-default site, All Sites; and the default storage grade, All Storage Nodes.
+
