...
*Note:* Noncurrent Time applies only to S3 objects in versioning-enabled buckets. See xref:managing-objects-with-s3-object-lock.adoc[Manage objects with S3 Object Lock].
