...
---
= Work with the ILM policy and ILM rules
:icons: font
:imagesdir: ../media/
...
. As needed, select *Active policy*, *Proposed policy*, and *Policy history* to view the details for each. In each tab, you can select *Policy rules* and *Retention diagram*.
