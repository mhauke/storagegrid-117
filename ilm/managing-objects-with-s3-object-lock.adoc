...
* In governance mode, users with special permissions can change an object's retention settings. 
a|
...
* In governance mode, users with special permissions can delete an object before its retain-until-date is reached.
a|
