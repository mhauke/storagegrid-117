...
+
The table lists only the rules that are compliant and do not use any filters. Periodically, the list of rules is automatically updated to reflect additions or removals. If you select a rule that is then deleted, an error message will appear.
+
