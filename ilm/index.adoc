...
+
image::../media/video-screenshot-ilm-rules-117.png[https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=6baa2e69-95b7-4bcf-a0ff-afbd0092231c" alt="Video: Information lifecycle management rules in StorageGRID 11.7", window=_blank]
