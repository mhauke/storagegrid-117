...
The Dashboard consists of tabs, and corresponding cards for each tab, that contain summary information about system health, storage use, ILM processes, and S3 and Swift operations. You can configure the Dashboard to contain the tabs and cards that meet your monitoring requirements.
