...
* Configuring the settings for a link:../admin/configuring-storage-proxy-settings.html[Storage proxy] or an link:../admin/configuring-admin-proxy-setting.html[Admin proxy] 
...
** link:../sg5600/upgrading-santricity-os-on-storage-controllers-using-grid-manager-sg5600.html[Upgrade SANtricity OS on SG5600 storage controllers using Grid Manager]
