...
** link:../sg5600/upgrading-santricity-os-on-storage-controllers-using-grid-manager-sg5600.html[Upgrade SANtricity OS on SG5700 storage controllers using Grid Manager]
