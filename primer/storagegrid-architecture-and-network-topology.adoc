...
* *Archive Nodes (optional, deprecated as of StorageGRID 11.7)* provide an interface through which object data can be archived to tape.
...
* link:../installconfig/hardware-description-sg5600.html[SG5600 storage appliances]
