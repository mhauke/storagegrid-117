...
If the xref:../admin/enabling-http-for-client-communications.adoc[*Enable HTTP Connection* option] is selected, clients must use different ports for HTTP than they use for HTTPS.
