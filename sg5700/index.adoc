...
Procedures for maintaining your appliance are in this section. See xref:../installconfig/configuring-hardware.adoc[Configure hardware] for maintenance procedures that are also performed during initial appliance installation and configuration.
