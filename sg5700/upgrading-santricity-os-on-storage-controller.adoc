...
+
xref:../5700/upgrading-santricity-os-on-storage-controllers-using-grid-manager-sg5700.adoc[Upgrade SANtricity OS on storage controllers using Grid Manager]
...
+
xref:../5700/upgrading-santricity-os-on-e2800-controller-using-maintenance-mode.adoc[Upgrade SANtricity OS on E2800 controller using maintenance mode]
