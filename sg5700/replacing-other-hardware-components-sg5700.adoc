...
* The appliance has been link:../maintain/placing-appliance-into-maintenance-mode.html[placed into maintenance mode] if the component replacement procedure requires that you shut down the appliance.
