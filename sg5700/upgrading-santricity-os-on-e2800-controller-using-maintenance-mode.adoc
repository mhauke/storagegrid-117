...
* You must place the E5700SG controller into link:../maintain/placing-appliance-into-maintenance-mode.html[maintenance mode], which interrupts the connection to the E2800 controller.
+
...
. Confirm the appliance is in link:../maintain/placing-appliance-into-maintenance-mode.html[maintenance mode].
