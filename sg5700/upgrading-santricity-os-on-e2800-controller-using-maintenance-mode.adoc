...
* You must place the E5700SG controller into 
xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[maintenance mode], which interrupts the connection to the E2800 controller.
+
