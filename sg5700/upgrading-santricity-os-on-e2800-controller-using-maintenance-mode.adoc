...
* You must place the E5700SG controller into xref:../maintain/placing-appliance-into-maintenance-mode.adoc[maintenance mode], which interrupts the connection to the E2800 controller.
+
...
. Confirm the appliance is in xref:../maintain/placing-appliance-into-maintenance-mode.adoc[maintenance mode].
