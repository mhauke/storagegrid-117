...
The appliance Storage Node will not be accessible when you replace the controller. If the E2800 controller is functioning sufficiently, you can xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[place the E5700SG controller into maintenance mode].
...
. If the StorageGRID appliance is running in a StorageGRID system, xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[place the E5700SG controller into maintenance mode].
