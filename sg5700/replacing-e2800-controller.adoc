...
The appliance Storage Node will not be accessible when you replace the controller. If the E2800 series controller is functioning sufficiently, you can xref:../maintain/placing-appliance-into-maintenance-mode.adoc[place the E5700SG controller into maintenance mode].
...
.Steps
. If the StorageGRID appliance is running in a StorageGRID system, xref:../maintain/placing-appliance-into-maintenance-mode.adoc[place the E5700SG controller into maintenance mode].
