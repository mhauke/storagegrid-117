...
*Note:* If you select 25 GbE, you must install SPF28 transceivers. Autonegotiation is not supported, so you must also configure the ports and the connected switches for 25GbE.
...
link:../installconfig/reviewing-appliance-network-connections.html[Review appliance network connections (SG5700)]

link:../installconfig/port-bond-modes-for-e5700sg-controller-ports.html[Port bond modes for E5700SG controller ports]

link:../installconfig/configuring-hardware.html[Configure hardware (SG5700)]
