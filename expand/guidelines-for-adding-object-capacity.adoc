...
* To add one or two expansion shelves to an SG6060 storage appliance, go to link:../sg6000/adding-expansion-shelf-to-deployed-sg6060.html[Add expansion shelf to deployed SG6060].
