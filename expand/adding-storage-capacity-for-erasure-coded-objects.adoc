...
+
In this example, the existing nodes are 100% full. Because there is no free capacity, you must immediately add three nodes.
+
NOTE: If you are unable to add three new nodes, see link:considerations-for-rebalancing-erasure-coded-data.html[Considerations for rebalancing erasure-coded data].
+
