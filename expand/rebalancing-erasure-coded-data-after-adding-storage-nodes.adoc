...
+
IMPORTANT: If your Storage Nodes contain a very large number of erasure-coded fragments, you might need to run the EC rebalance procedure more than once to completely rebalance erasure-coded data.
