...
See the link:../admin/managing-object-metadata-storage.html[description of what Metadata Reserved Space is] and link:../upgrade/increasing-metadata-reserved-space-setting.html[how to increase Metadata Reserved Space].
