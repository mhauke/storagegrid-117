...
NOTE: VLAN interfaces can be added to Admin Nodes and Gateway Nodes only. You cannot use a VLAN interface for client or admin access to Storage Nodes or Archive Nodes.
...
* link:networking-requirements-and-guidelines.html[Networking requirements]
