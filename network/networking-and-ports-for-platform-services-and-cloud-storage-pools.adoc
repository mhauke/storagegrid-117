...
* Rely on the default route provided by a Client Network. If you use the default route, you can use the xref:../admin/manage-firewall-controls.adoc[untrusted Client Network feature] to restrict inbound connections.
