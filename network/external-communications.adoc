...
NOTE: This list does not include ports that might be configured as link:../admin/configuring-load-balancer-endpoints.html[load balancer endpoints] or used for link:..//monitor/configure-syslog-server.html[syslog servers].
