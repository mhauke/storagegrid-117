...
See xref:../tenant/creating-s3-bucket.adoc[Create an S3 bucket] and xref:../tenant/configure-s3-object-lock-settings-for-bucket.adoc[Update S3 Object Lock settings for a bucket].
