...
* If you are performing an offline upgrade, you have xref:../maintain/placing-appliance-into-maintenance-mode.adoc[placed the StorageGRID appliance in maintenance mode].
+
...
. If you are performing an offline upgrade, confirm that the appliance is in xref:../maintain/placing-appliance-into-maintenance-mode.adoc[maintenance mode].
...
xref:../sg5700/upgrading-santricity-os-on-storage-controllers-using-grid-manager-steps.adoc[Upgrade SANtricity OS on storage controllers]
