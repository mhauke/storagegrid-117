...
[.lead]
Upgrade the firmware on the drives in your appliance to make sure you have all the latest features and bug fixes. In some cases, you can upgrade the drives without putting the appliance into maintenance mode. 
...
* If you xxxxxxxx, you have xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[placed the StorageGRID appliance in maintenance mode].
+
...
. If xxxxx, confirm that the appliance is in xref:../commonhardware/placing-appliance-into-maintenance-mode.adoc[maintenance mode].
 ...
 ** Use the Grid Manager and select *NODES* > *Storage Node* > *SANtricity System Manager* 
