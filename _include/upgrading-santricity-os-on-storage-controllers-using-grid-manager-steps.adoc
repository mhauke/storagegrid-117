...
IMPORTANT: Be sure to apply the latest StorageGRID hotfix before you begin this procedure. See xref:../maintain/storagegrid-hotfix-procedure.adoc[StorageGRID hotfix procedure] for details. 
