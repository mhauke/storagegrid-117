...
+
CAUTION: If you create a new access key and secret access key in the future, you must update the corresponding values in ONTAP immediately to ensure that ONTAP can store and retrieve data in StorageGRID without interruption.
