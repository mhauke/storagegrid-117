...
For details about this task, see the general xref:../admin/managing-load-balancer-endpoints.adoc[considerations for load balancing] and the xref:best-practices-for-load-balancing.adoc[best practices for load balancing for FabricPool].
