...
* Do not create rules that will move FabricPool cloud tier data out of the bucket to another location. You cannot use a Cloud Storage Pool to move FabricPool data to another object store. Similarly, you cannot archive FabricPool data to tape using an Archive Node. 
+
