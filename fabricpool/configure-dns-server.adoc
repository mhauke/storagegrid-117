...
If you have defined xref:../admin/configuring-s3-api-endpoint-domain-names.adoc[S3 endpoint domain names] and you will use virtual hosted-style requests, add DNS entries for all required S3 endpoint domain names, including any wildcard names.
