...
For FabricPool buckets, the recommended bucket consistency level is "`Read-after-new-write,`" which the default setting for a new bucket. Do not edit FabricPool buckets to use the "`Available`" or any other consistency level.
