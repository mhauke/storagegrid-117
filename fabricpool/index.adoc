...
* Review the best practices for link:best-practices-for-high-availability-groups.html[HA groups], link:best-practices-for-load-balancing.html[load balancing], link:best-practices-ilm.html[ILM], and link:other-best-practices-for-storagegrid-and-fabricpool.html[more].
